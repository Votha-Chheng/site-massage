  ...
  return (
    <FooterStyle>
      <div className="footer-container">
        ...
        <div className="part-right">
          ...
          <div className="reseau">
            <a href="https://www.facebook.com/bauxt.dessens.73" target="_blank" rel='noopener noreferrer'>
              <svg width="75" height="80" viewBox="0 0 185 201" fill="none" xmlns="http://www.w3.org/2000/svg" alt="baux't des sens sur Facebook">
            ...
            <a href="https://www.instagram.com/bauxtdessens/" target="_blank" rel='noopener noreferrer'>
              <svg width="83" height="83" viewBox="0 0 170 170" fill="none" xmlns="http://www.w3.org/2000/svg" alt="baux't des sens sur Instagram">
      ...
      <div className='credit'>
        Copyright - Juillet 2021 &copy; <a className="link-footer" href="https://github.com/Votha-Chheng" target="_blank" rel='noopener noreferrer'>Votha Chheng</a>
      </div>
    </FooterStyle>
  );
}
